              ...
              <section className='studio-single-image-grid-sec'>
                ...
                <div className='studio-single-photo-grid-container'>
                  <div className='photo-grid-row'>
                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_1.image_1.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_1.image_1.image.url}
                      metaData={acf.photo_gallery.gallery_row_1.image_1.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_1.image_2.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_1.image_2.image.url}
                      metaData={acf.photo_gallery.gallery_row_1.image_2.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_1.image_3.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_1.image_3.image.url}
                      metaData={acf.photo_gallery.gallery_row_1.image_3.meta_data}
                    />
                  </div>
                  <div className='photo-grid-row'>
                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_2.image_1.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_2.image_1.image.url}
                      metaData={acf.photo_gallery.gallery_row_2.image_1.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_2.image_2.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_2.image_2.image.url}
                      metaData={acf.photo_gallery.gallery_row_2.image_2.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_2.image_3.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_2.image_3.image.url}
                      metaData={acf.photo_gallery.gallery_row_2.image_3.meta_data}
                    />
                  </div>

                  <div className='photo-grid-row'>
                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_3.image_1.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_3.image_1.image.url}
                      metaData={acf.photo_gallery.gallery_row_3.image_1.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_3.image_2.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_3.image_2.image.url}
                      metaData={acf.photo_gallery.gallery_row_3.image_2.meta_data}
                    />

                    <PhotoGridImage
                      imageSize={acf.photo_gallery.gallery_row_3.image_3.image.sizes}
                      imageUrl={acf.photo_gallery.gallery_row_3.image_3.image.url}
                      metaData={acf.photo_gallery.gallery_row_3.image_3.meta_data}
                    />
                  </div>
                </div>
              </section>
