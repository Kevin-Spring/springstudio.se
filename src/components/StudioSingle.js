...
import '../styles/scss/_studioSingle.scss'
        ...
        <div key={posts.id}>
          <motion.section className='studio-single-hero-sec' initial='initial' animate='animate' variants={motionContent}>
            <header className='studio-single-hero-header'>
              ...
              <motion.p variants={motionParagraph}>{posts.acf.preamble}</motion.p>
            </header>
          ...
          <section className='studio-single-slider-sec'>
            ...
            <Slider {...settings}>
              <SlideImage imageSize={posts.acf.slides_section.slides.slide_1.sizes} imageUrl={posts.acf.slides_section.slides.slide_1.url} />
          ...
          <section className='studio-single-image-grid-sec'>
            ...
            <div className='studio-single-photo-grid-container'>
              <div className='photo-grid-row'>
                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_1.image_1.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_1.image_1.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_1.image_1.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_1.image_2.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_1.image_2.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_1.image_2.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_1.image_3.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_1.image_3.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_1.image_3.meta_data}
                />
              </div>
              <div className='photo-grid-row'>
                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_2.image_1.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_2.image_1.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_2.image_1.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_2.image_2.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_2.image_2.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_2.image_2.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_2.image_3.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_2.image_3.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_2.image_3.meta_data}
                />
              </div>

              <div className='photo-grid-row'>
                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_3.image_1.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_3.image_1.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_3.image_1.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_3.image_2.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_3.image_2.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_3.image_2.meta_data}
                />

                <PhotoGridImage
                  imageSize={posts.acf.photo_gallery.gallery_row_3.image_3.image.sizes}
                  imageUrl={posts.acf.photo_gallery.gallery_row_3.image_3.image.url}
                  metaData={posts.acf.photo_gallery.gallery_row_3.image_3.meta_data}
                />
              </div>
            </div>
          </section>
          ...
          <section className='studio-single-contact-section'>
            ...
            <div ref={addToFadeInTexts} className='fade'>
              <Link to={posts.acf.contact_section.contact_cta.url} className='booking-link'>
                {posts.acf.contact_section.contact_cta.title} <VscArrowRight className='booking-arrow' />
              </Link>
            </div>
